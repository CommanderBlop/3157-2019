...
void autonRedBack() {
  ...
  Intake::getInstance() -> setPos(-1);
  task::sleep(300);
  DriveTrain::getInstance() -> moveForward(ONE_TILE*2.5, 50);
  task::sleep(200);
  ...
  //nudge stack and back
  DriveTrain::getInstance() -> moveForward(ONE_TILE*.05, 15);
  task::sleep(300);

  DriveTrain::getInstance() -> moveBackward(ONE_TILE*.10, 15);
  task::sleep(500);
  ...
  DriveTrain::getInstance() -> stop();
  task::sleep(300);
  DriveTrain::getInstance() -> turnLeft(80, 50);
